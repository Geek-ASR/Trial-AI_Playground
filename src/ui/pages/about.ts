    ...
    h('section', { class: 'prose' },
      ...
      h('table', { class: 'controls' },
        h('tbody', null,
          ...
          row('Shift', 'Sprint · descend while flying'), row('F', 'Toggle flying'), row('E', 'Open the nearest lesson'),
          row('Left / right click', 'Break / place block'), row('1–9 · scroll', 'Choose a block'), row('B', 'Code Builder'), row('M', 'Map & teleport'), row('H', 'Back to the Hub'), row('Esc', 'Release the mouse / close panels'),
        ),
      ),
      h('h2', null, 'Your data'),
      ...
      h('p', null, h('a', { class: 'btn', href: 'https://github.com/Geek-ASR/neuralcraft', target: '_blank', rel: 'noopener' }, 'View on GitHub')),
      h('h2', null, 'Author'),
